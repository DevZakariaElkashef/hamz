...
class SliderRepository
{
    ...
    {
        $sliders = Slider::filter($request)->booth()->paginate($request->per_page ?? $this->limit);
    ...
    {
        return Slider::booth()->search($request->search)->paginate($request->per_page ?? $this->limit);
    }
    ...
    {
        Slider::booth()->whereNot('id', $currentSliderId)->update(['is_fixed' => 0]);
    }
