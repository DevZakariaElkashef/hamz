...
use App\Http\Requests\rfoof\Employee\AddRequest;
use App\Http\Requests\rfoof\Employee\UpdateRequest;
...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $graves = 0;
        $contact = 0;
        return view('rfoof.index', compact('admins', 'employees', 'dead_information', 'graves', 'contact'));
    }
