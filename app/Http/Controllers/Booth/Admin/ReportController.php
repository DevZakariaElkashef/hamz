...
use App\Exports\Booth\AllOrderDetailsReportExport;
use App\Exports\Booth\AllProductSalesReportExport;
use App\Exports\Booth\AllVendorSalesReportExport;
use App\Exports\Booth\CustomerActivityReportExport;
use App\Exports\Booth\LowStockAlertsReportExport;
use App\Exports\Booth\OrderStatusReportExport;
...
class ReportController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // autherization
        $this->middleware('can:booth.report.product_sales')->only(['allProductSalesReport', 'searchAllProductSalesReport', 'exportAllProductSalesReport']);
        $this->middleware('can:booth.report.vendor_sales')->only(['allVendorSalesReport', 'searchAllVendorSalesReport', 'exportAllVendorSalesReport']);
        $this->middleware('can:booth.report.order_status')->only(['orderStatusReport', 'exportOrderStatusReport']);
        $this->middleware('can:booth.report.order_details')->only(['allOrderDetailsReport', 'searchAllOrderDetailsReport', 'exportAllOrderDetailsReport']);
        $this->middleware('can:booth.report.customer_activity')->only(['customerActivityReport', 'searchCustomerActivityReport', 'exportCustomerActivityReport']);
        $this->middleware('can:booth.report.low_stock_alert')->only(['lowStockAlertsReport', 'searchLowStockAlertsReport', 'exportLowStockAlertsReport']);
    }
    ...
    public function allVendorSalesReport(Request $request)
    {
        ...
        return view('booth.reports.vendors.all_vendor_sales', compact('sales'));
    }
    ...
    public function searchAllVendorSalesReport(Request $request)
    {
        ...
        return view('booth.reports.vendors.all_vendor_sales_table', compact('sales'))->render();
    }
    ...
    public function orderStatusReport(Request $request)
    {
        ...
        return view('booth.reports.orders.order_status_report', compact('orders', 'stores', 'sections'));
    }
    ...
    public function allOrderDetailsReport(Request $request)
    {
        ...
        return view('booth.reports.orders.all_order_details', compact('orders', 'sections', 'stores'));
    }
    ...
    public function searchAllOrderDetailsReport(Request $request)
    {
        ...
        return view('booth.reports.orders.all_order_details_table', compact('orders'))->render();
    }
    ...
    public function customerActivityReport(Request $request)
    {
        ...
        return view('booth.reports.customers.customer_activity', compact('customers'));
    }
    ...
    public function searchCustomerActivityReport(Request $request)
    {
        ...
        return view('booth.reports.customers.customer_activity_table', compact('customers'))->render();
    }
    ...
    {
        $products = Product::search($request)->booth()->where('qty', '<', 10) // Assuming stock threshold is 10
            ->get();
        return view('booth.reports.products.low_stock_alerts_table', compact('products'));
    }
