...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('earn.videos.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>
            @can('earn.videos.create')
                <div class="mb-3 mb-xl-0">
                    <a href="{{ route('earn.videos.create') }}" class="btn btn-primary ">{{ __('main.create') }}</a>
                </div>
            @endcan
        </div>
    </div>
    ...
    <div class="modal" id="filterModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('earn.videos.index') }}">
                    <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('earn.videos.delete') }}">{{ __('main.delete') }}</a>

                            <input type="text" id="searchInput" data-url="{{ route('earn.videos.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('earn.videos.index') }}" onchange="updatePageSize()">
