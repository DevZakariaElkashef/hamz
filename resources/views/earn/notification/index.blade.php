...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('earn.notifications.index') }}">ألاشعارات</a></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('earn.notifications.index') }}" class="btn btn-warning  btn-icon ml-2"><i
    ...
    {{-- <div class="modal" id="filterModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('earn.notifications.index') }}">
                    <div class="modal-body">
                        <div class="form-group">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">ألاشعارات</h4>
                        <div class="d-flex">
                            {{-- <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('earn.notifications.delete') }}">{{ __('main.delete') }}</a> --}}
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('earn.notifications.index') }}" onchange="updatePageSize()">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('earn.notification.table')
                    </div>
                </div>
            </div>
        </div>
