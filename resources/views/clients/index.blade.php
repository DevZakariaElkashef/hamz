...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('clients.index') }}">{{ __('main.clients') }}</a></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('clients.export', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active'), 'store_id' => request('store_id')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('clients.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('clients.create') }}" class="btn btn-primary ">{{ __('main.create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="modal" id="importmodal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('clients.import') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ asset('imports/clients.xlsx') }}" download
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('clients.index') }}">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="city_id">{{ __('main.city') }}</label>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ __('main.clients') }}</h4>
                        <div class="d-flex">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('clients.delete') }}">{{ __('main.delete') }}</a>
                            <input type="text" id="searchInput" data-url="{{ route('clients.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('clients.index') }}" onchange="updatePageSize()">
