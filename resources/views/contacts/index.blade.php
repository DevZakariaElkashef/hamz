...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('contacts.index') }}">{{ __('main.contacts') }}</a></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('contacts.index') }}" class="btn btn-warning  btn-icon ml-2"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{ __('main.show') }}</h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                    <div class="modal-body">
                        <p class="text-center my-2" id="contactMessage"></p>
                    </div>
                ...
                <form method="get" action="{{ route('contacts.index') }}">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="read_at" class="form-control">
                                <option value="">{{ __('main.all') }}</option>
                                <option value="0" @if(request('read_at') == '0') selected @endif>{{ __('main.not_readed') }}</option>
                                <option value="1" @if(request('read_at') == '1') selected @endif>{{ __('main.readed') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ __('main.contacts') }}</h4>
                        <div class="d-flex align-items-center">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('contacts.delete') }}">{{ __('main.delete') }}</a>

                            <input type="text" id="searchInput" data-url="{{ route('contacts.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('contacts.index') }}" onchange="updatePageSize()">
