    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('terms.edit', $term->id) }}">{{ __('main.edit_term') }}</a></span>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('terms.update', $term->id) }}" data-parsley-validate=""
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mg-b-0">
                                ...
                                <textarea class="form-control" name="item_ar" placeholder="{{ __('main.enter_item') }}" required="">{{ old('item_ar') ?? $term->item_ar }}</textarea>
                                @error('item_ar')
                            ...
                            <div class="col-md-6 form-group mg-b-0">
                                <label class="form-label">{{ __('main.item') }}(EN): <span
                                        class="tx-danger">*</span></label>
                                <textarea class="form-control" name="item_en" placeholder="{{ __('main.enter_item') }}" required="">{{ old('item_en') ?? $term->item_en }}</textarea>
                                @error('item_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 form-group mg-b-0">
                                ...
                                <select required class="form-control" name="is_active">
                                    <option value="0" @if (old('is_active', $term->is_active) == 0) selected @endif>
                                        {{ __('main.not_active') }}</option>
                                    <option value="1" @if (old('is_active', $term->is_active) == 1) selected @endif>
