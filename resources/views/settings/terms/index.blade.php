        ...
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('terms.index') }}">{{ __('main.back') }}</a></span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea id="value_ar" class="form-control" type="text" name="value_ar">{{ $term->value_ar ?? '' }}</textarea>
                                    @error('value_ar')
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea id="value_en" class="form-control" type="text" name="value_en">{{ $term->value_en  ?? '' }}</textarea>
                                    @error('value_en')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
