    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('socials.create') }}">{{ __('main.create_social') }}</a></span>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('socials.store') }}" data-parsley-validate=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mt-4">
                                <div class="custom-file">
                                    ...
                                    <input class="custom-file-input" required id="customFile" type="file" name="icon">
                                    @error('icon')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
