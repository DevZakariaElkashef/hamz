    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('mall.categories.create') }}" class="btn btn-primary ">{{ __('mall.create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="modal" id="importmodal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('mall.categories.import') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ asset("imports/categories.xlsx") }}" download class="btn btn-warning">{{ __('mall.download_example') }}</a>
                        </div>
                    </div>
