...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            @can('mall.coupons.export')
                <div class="pr-1 mb-3 mb-xl-0">
                    <a href="{{ route('mall.coupons.export', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.coupons.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>

            @can('mall.coupons.create')
                <div class="mb-3 mb-xl-0">
                    <a href="{{ route('mall.coupons.create') }}" class="btn btn-primary ">{{ __('main.create') }}</a>
                </div>
            @endcan
        </div>
    </div>
    ...
    <div class="modal" id="importmodal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('mall.coupons.import') }}"
    ...
    <div class="modal" id="filterModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('mall.coupons.index') }}">
                    <div class="modal-body">
                        <div class="form-group">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('mall.coupons.delete') }}">{{ __('main.delete') }}</a>

                            <input type="text" id="searchInput" data-url="{{ route('mall.coupons.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('mall.coupons.index') }}" onchange="updatePageSize()">
