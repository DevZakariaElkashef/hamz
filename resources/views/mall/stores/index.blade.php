    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('mall.stores.create') }}" class="btn btn-primary ">{{ __('mall.create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('mall.stores.import') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ asset("imports/stores.xlsx") }}" download class="btn btn-warning">{{ __('mall.download_example') }}</a>
                        </div>
                    </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('mall.stores.index') }}" onchange="updatePageSize()">
