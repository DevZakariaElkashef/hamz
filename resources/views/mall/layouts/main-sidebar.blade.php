...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category">{{ __('mall.general') }}</li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.sliders.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.sliders') }}</span>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.sections.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.sections') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.cities.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.cities') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.stores.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.stores') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.coupons.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.coupons') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.categories.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.categories') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.brands.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.brands') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.attributes.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.attributes') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.options.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.options') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.products.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.products') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('mall.orders.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('mall.orders') }}</span>
                    {{-- <span class="badge badge-danger side-badge">New</span> --}}
                </a>
            </li>
