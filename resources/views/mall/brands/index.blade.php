    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('mall.brands.index') }}">{{ __('mall.brands') }}</a></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('mall.brands.create') }}" class="btn btn-primary ">{{ __('mall.create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ __('mall.brands') }}</h4>
                        <div class="d-flex">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('mall.brands.delete') }}">{{ __('mall.delete') }}</a>
