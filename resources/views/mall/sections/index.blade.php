...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.sections.export', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.sections.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('mall.sections.create') }}" class="btn btn-primary ">{{ __('mall.create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('mall.sections.import') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ asset("imports/sections.xlsx") }}" download class="btn btn-warning">{{ __('mall.download_example') }}</a>
                        </div>
                    </div>
