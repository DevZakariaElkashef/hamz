    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('mall.sections.edit', $section->id) }}">{{ __('mall.edit_section') }}</a></span>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mg-b-0">
                                ...
                                <select required class="form-control" name="is_active">
                                    <option value="0" @if (old('is_active') == 0 || $section->is_active == 0) selected @endif>
                                        {{ __('not_active') }}</option>
                                    <option value="1" @if (old('is_active') == 1 || $section->is_active == 1) selected @endif>
                                        {{ __('active') }}</option>
                                </select>
                                @error('url')
                                    <div class="text-danger">{{ $message }}</div>
