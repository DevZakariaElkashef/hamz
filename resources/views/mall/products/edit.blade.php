    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('mall.products.update', $product->id) }}" data-parsley-validate=""
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mg-b-0">
                                ...
                                <input class="form-control" name="name_ar" placeholder="{{ __('mall.enter_name') }}"
                                    required="" type="text" value="{{ old('name_ar') ?? $product->name_ar }}">
                                @error('name_ar')
                            ...
                            <div class="col-md-6 form-group mg-b-0">
                                ...
                                <input class="form-control" name="name_en" placeholder="{{ __('mall.enter_name') }}"
                                    required="" type="text" value="{{ old('name_en') ?? $product->name_en }}">
                                @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 form-group mg-b-0">
                                ...
                                <input class="form-control" name="url" placeholder="{{ __('mall.enter_name') }}"
                                    type="url" value="{{ old('url') ?? $product->url }}">
                                @error('url')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
