    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.reports.orderStatusExport', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'section_id' => request('section_id'), 'store_id' => request('store_id'),]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.reports.orderStatus') }}" class="btn btn-warning  btn-icon ml-2"><i
      ...
      <div class="modal" id="filterModal">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('mall.reports.orderStatus') }}">
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('mall.reports.orders.order_status_report_table')
                    </div>
                </div>
            </div>
        </div>
