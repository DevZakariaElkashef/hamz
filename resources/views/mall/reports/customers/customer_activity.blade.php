        ...
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('mall.reports.customerActivity') }}">{{ __('mall.Product_Sales') }}</a></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">

            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.reports.customerActivityExport', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active'), 'category_id' => request('category_id'), 'brand_id' => request('brand_id')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('mall.reports.customerActivity') }}" class="btn btn-warning  btn-icon ml-2"><i
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" id="searchReport"
                                data-url="{{ route('mall.reports.customerActivitySearch') }}" class="form-control"
                                placeholder="{{ __('mall.search') }}">
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('mall.reports.customerActivity') }}" onchange="updatePageSize()">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('mall.reports.customers.customer_activity_table')
                    </div>
                </div>
            </div>
        </div>
