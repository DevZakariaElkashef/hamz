        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('usedMarket.addsubCategories') }}" class="btn btn-primary button-icon"><i
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            ...
                                            <a class="btn btn-outline-secondary bg-warning text-dark btn-sm ml-2"
                                                title="{{ __('admin.edit') }}"
                                                href="{{ route('usedMarket.subCategories.edit', [$new->id]) }}">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form class="d-inline"
                                                            action="{{ route('usedMarket.subCategories.delete') }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('Delete')
