...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('vendors.export', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active'), 'store_id' => request('store_id')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('vendors.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('vendors.create') }}" class="btn btn-primary ">{{ __('main.create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="modal" id="importmodal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('vendors.import') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ asset('imports/vendors.xlsx') }}" download
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('vendors.delete') }}">{{ __('main.delete') }}</a>
                            <input type="text" id="searchInput" data-url="{{ route('vendors.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('vendors.index') }}" onchange="updatePageSize()">
