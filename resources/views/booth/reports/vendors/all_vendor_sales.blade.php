    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.allVendorSalesExport', ['search' => request('search')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.allVendorSales') }}" class="btn btn-warning  btn-icon ml-2"><i
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            <input type="text" id="searchReport" data-url="{{ route('booth.reports.allVendorSalesSearch') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('booth.reports.allVendorSales') }}" onchange="updatePageSize()">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('booth.reports.vendors.all_vendor_sales_table')
                    </div>
                </div>
            </div>
        </div>
