        ...
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('booth.reports.allOrderDetails') }}">{{ __('main.Product_Sales') }}</a></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">

            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.allOrderDetailsExport', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'section_id' => request('section_id'), 'store_id' => request('store_id'),]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.allOrderDetails') }}" class="btn btn-warning  btn-icon ml-2"><i
      ...
      <div class="modal" id="filterModal">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('booth.reports.allOrderDetails') }}">
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('booth.reports.orders.all_order_details_table')
                    </div>
                </div>
            </div>
        </div>
