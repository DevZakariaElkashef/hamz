    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.lowStockAlertsExport', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active'), 'category_id' => request('category_id'), 'brand_id' => request('brand_id')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.lowStockAlerts') }}" class="btn btn-warning  btn-icon ml-2"><i
    ...
    <div class="modal" id="filterModal">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('booth.reports.lowStockAlerts') }}">
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" id="searchReport"
                                data-url="{{ route('booth.reports.lowStockAlertsSearch') }}" class="form-control"
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('booth.reports.products.low_stock_alerts_table')
                    </div>
                </div>
            </div>
        </div>
