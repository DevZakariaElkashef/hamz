    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.allProductSalesExport', ['search' => request('search')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.reports.allProductSales') }}" class="btn btn-warning  btn-icon ml-2"><i
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" id="searchReport"
                                data-url="{{ route('booth.reports.allProductSalesSearch') }}" class="form-control"
                                placeholder="{{ __('main.search') }}">

                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('booth.reports.allProductSales') }}" onchange="updatePageSize()">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('booth.reports.products.all_product_sales_table')
                    </div>
                </div>
            </div>
        </div>
