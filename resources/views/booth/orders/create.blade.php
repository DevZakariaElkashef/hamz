    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('booth.orders.create') }}">{{ __('main.create_order') }}</a></span>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <form id="createOrderForm" method="post" action="{{ route('booth.orders.store') }}"
                        ...
                        <div id="wizard1">
                            ...
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('main.inventory') }}:</label>
