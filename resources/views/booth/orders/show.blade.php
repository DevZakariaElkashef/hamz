...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0 ml-3">
                <div class="btn-group dropdown">
                    <button type="button" class="btn btn-danger" id="deleteOrderBtn"
                        data-url="{{ route('booth.orders.destroy', $order->id) }}" data-toggle="modal"
            ...
            <div class="mb-3 mb-xl-0 ml-3">
                <div class="btn-group dropdown">
                    <a href="{{ route('booth.invoices.show', $order) }}" target="_blank" class="btn btn-dark "
...
@section('content')
    ...
    <div class="modal fade " id="addProductModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="POST" action="{{ route('booth.orderitems.store') }}" id="addProductModalvalid"
    ...
    <div class="modal fade " id="ModalChangeStatusOrder" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="POST" id="ModalChangeStatusOrdervalid" enctype="multipart/form-data"
                action="{{ route('booth.orders.updateStatus') }}">
                @csrf
                <input type="hidden" id="id" name="id" value="{{ $order->id }}">
                <div class="modal-content ">
                    <div class="modal-header">
    ...
    <div class="modal fade " id="ModalChangeMethodStatusOrder" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <form method="POST" id="ModalMethodStatusOrdervalid" enctype="multipart/form-data"
                action="{{ route('booth.orders.updatePayment') }}">
                @csrf
                <input type="hidden" id="id" name="id" value="{{ $order->id }}">
                <div class="modal-content ">
                    <div class="modal-header">
                                ...
                                <table class="table table-bordered table-hover mb-0 text-nowrap">
                                    ...
                                    <tbody id="order-items-body">
                                        @foreach ($order->orderItems as $order_item)
                                            <tr>
                                                <form action="{{ route('booth.orderitems.update', $order_item) }}"
                                                    method="post">
                                                    @method('put')
                                                    @csrf
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" id="deleteproductItem"
                                                            data-url="{{ route('booth.orderitems.destroy', $order_item->id) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.product-select', function() {
                ...
                fetch(`/booth/fetch-products/${selectedProductId}`)
