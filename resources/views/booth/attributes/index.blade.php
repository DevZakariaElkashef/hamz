        ...
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('booth.attributes.index') }}">{{ __('main.attributes') }}</a></span>
            </div>
        </div>

        <div class="d-flex my-xl-auto right-content">
            @can('booth.attributes.import')
            ...
            @can('booth.attributes.export')
                <div class="pr-1 mb-3 mb-xl-0">
                    <a href="{{ route('booth.attributes.export', ['start_at' => request('start_at'), 'end_at' => request('end_at'), 'is_active' => request('is_active')]) }}"
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('booth.attributes.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>

            @can('booth.attributes.create')
                <div class="mb-3 mb-xl-0">
                    <a href="{{ route('booth.attributes.create') }}" class="btn btn-primary ">{{ __('main.create') }}</a>
                </div>
            @endcan
        </div>
    </div>
    ...
    <div class="modal" id="importmodal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="POST" id="importForm" action="{{ route('booth.attributes.import') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ asset('imports/attributes.xlsx') }}" download
    ...
    <div class="modal" id="filterModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="get" action="{{ route('booth.attributes.index') }}">
                    <div class="modal-body">
                        <div class="form-group">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ __('main.attributes') }}</h4>
                        <div class="d-flex">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('booth.attributes.delete') }}">{{ __('main.delete') }}</a>
                            <input type="text" id="searchInput" data-url="{{ route('booth.attributes.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('booth.attributes.index') }}" onchange="updatePageSize()">
                ...
                <div class="card-body">
                    <div id="tableFile">
                        @include('booth.attributes.table')
                    </div>
                </div>
            </div>
        </div>
